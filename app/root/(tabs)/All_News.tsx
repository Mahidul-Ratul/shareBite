              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={{ flex: 1, minHeight: 90, justifyContent: 'space-between' }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#16a34a', borderRadius: 14, paddingHorizontal: 12, paddingVertical: 5 }} onPress={() => router.push({ pathname: './news_details', params: { news_id: item.id } })}>
